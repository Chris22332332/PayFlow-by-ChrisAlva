import { c as createLucideIcon, a as commonjsGlobal, g as getDefaultExportFromCjs, r as reactExports, b as clsx, R as React, i as invariant, P as PropTypes, u as useSpendingAnalytics, d as useSpendingTrend, e as useBudgets, f as useSetBudget, j as jsxRuntimeExports, C as ChartColumn, h as ChevronLeft, k as ChevronRight, B as Button, S as Skeleton, m as motion, Z as Zap, T as Target, l as TrendingDown, n as Receipt, o as TrendingUp, p as Card, q as CardContent, A as ArrowDownLeft, s as ArrowUpRight, t as CardHeader, v as CardTitle, w as Badge, H as Hash$2, U as Users, W as Wallet } from "./index-BQXzav6B.js";
/**
...
function formatCategoryPieData(summary) {
  return summary.categories.filter((c2) => c2.totalCents > 0).map((c2) => ({
    name: getCategoryLabel(c2.category),
    value: Math.round(c2.totalCents / 100),
    color: getCategoryColor(c2.category),
    percentage: c2.percentage,
    category: c2.category,
    emoji: getCategoryEmoji(c2.category)
  }));
}
function formatDailyBarData(summary) {
...
function formatCategoryBreakdownTable(categories, totalCents) {
  return categories.map((c2) => ({
    label: getCategoryLabel(c2.category),
    emoji: getCategoryEmoji(c2.category),
    color: getCategoryColor(c2.category),
    amountDollars: Math.round(c2.totalCents) / 100,
    percentage: totalCents > 0 ? Math.round(c2.totalCents / totalCents * 100) : 0,
    count: c2.count
  }));
}
...
function getBudgetBadgeClass(pct) {
  if (pct >= 90)
...
function DonutCenter({ total }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("text", { x: "50%", y: "50%", textAnchor: "middle", dominantBaseline: "middle", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("tspan", { x: "50%", dy: "-10", fontSize: "11", fill: "var(--muted-foreground)", children: "Total" }),
...
function BarTooltip({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-lg px-3 py-2 shadow-elevated text-xs space-y-1", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground font-medium", children: [
      "Day ",
      label
    ] }),
    payload.map((p2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-bold", style: { color: p2.color }, children: [
      p2.name,
      ": ",
...
function AnalyticsPage() {
  ...
  const [activePreset, setActivePreset] = reactExports.useState("this_month");
  ...
  function applyPreset(preset) {
    ...
    if (preset === "this_month") {
      setMonth(n2.getMonth() + 1);
      setYear(n2.getFullYear());
    } else if (preset === "last_month") {
      const d2 = new Date(n2.getFullYear(), n2.getMonth() - 1, 1);
      setMonth(d2.getMonth() + 1);
      setYear(d2.getFullYear());
    } else if (preset === "last_3") {
      const d2 = new Date(n2.getFullYear(), n2.getMonth() - 2, 1);
      setMonth(d2.getMonth() + 1);
      setYear(d2.getFullYear());
    } else {
      setMonth(1);
  ...
  const tableData = summary ? formatCategoryBreakdownTable(summary.categories, summary.totalSpentCents) : [];
  const avgTransaction = summary && summary.categories.reduce((s2, c2) => s2 + c2.count, 0) > 0 ? summary.totalSpentCents / summary.categories.reduce((s2, c2) => s2 + c2.count, 0) : 0;
  const biggestPurchase = summary ? Math.max(...summary.dailySpend.map((d2) => d2.amountCents), 0) : 0;
  const totalTxCount = summary ? summary.categories.reduce((s2, c2) => s2 + c2.count, 0) : 0;
  const presets = [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 pb-8", "data-ocid": "analytics.page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-2.5 rounded-xl bg-primary/10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChartColumn, { className: "h-5 w-5 text-primary" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-display font-bold", children: "Spending Analytics" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "Understand where your money goes" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 bg-card border border-border rounded-xl px-3 py-2 shadow-sm", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold min-w-[150px] text-center", children: formatMonthLabel(month, year) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: presets.map((p2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            variant: activePreset === p2.id ? "default" : "outline",
            size: "sm",
            onClick: () => applyPreset(p2.id),
            "data-ocid": `analytics.preset_${p2.id}`,
    ...
    isLoading && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-4", children: [0, 1, 2, 3].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-28 rounded-xl" }, i)) }),
    ...
    !isLoading && summary && summary.totalSpentCents === 0 && summary.totalReceivedCents === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-2xl bg-primary/10 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChartPie, { className: "h-8 w-8 text-primary" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-display font-bold", children: "No activity yet" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm max-w-xs leading-relaxed", children: "Send or receive money to start seeing your spending analytics, category breakdowns, and trends here." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2 mt-2 text-sm text-muted-foreground", children: [
    ...
    !isLoading && summary && (summary.totalSpentCents > 0 || summary.totalReceivedCents > 0) && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: [
                ...
                {
                  label: "Net Flow",
                  value: (summary.netCents >= 0 ? "+" : "") + formatCurrency(summary.netCents),
                  icon: summary.netCents >= 0 ? TrendingUp : TrendingDown,
                  iconBg: summary.netCents >= 0 ? "bg-primary/10" : "bg-destructive/10",
                  iconColor: summary.netCents >= 0 ? "text-primary" : "text-destructive",
                  id: "analytics.net_card",
                  sub: "income vs spend",
                  valueColor: summary.netCents >= 0 ? "text-primary" : "text-destructive"
                }
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "div",
                          {
                            ...
                            children: /* @__PURE__ */ jsxRuntimeExports.jsx(card.icon, { className: `h-4 w-4 ${card.iconColor}` })
                          }
                        ),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-muted-foreground mt-0.5", children: card.sub })
                        ] })
                      ] }) })
                    }
                  )
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 bg-primary/5 border border-primary/20 rounded-xl px-4 py-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowDownLeft, { className: "h-4 w-4 text-primary shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-primary", children: formatCurrency(summary.totalReceivedCents) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground ml-1", children: "received this month" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowUpRight, { className: "h-4 w-4 text-destructive shrink-0 ml-auto" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-destructive", children: formatCurrency(summary.totalSpentCents) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground ml-1", children: "spent" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.div,
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-base flex items-center gap-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(ChartPie, { className: "h-4 w-4 text-primary" }),
                    "Spending by Category"
                  ] }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { children: [
                    pieData.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        className: "h-48 flex items-center justify-center text-muted-foreground text-sm",
                        "data-ocid": "analytics.categories_empty_state",
                        children: "No spending data for this month"
                      }
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Pie,
                        {
                          ...
                          dataKey: "value",
                          strokeWidth: 0,
                          children: pieData.map((entry) => /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { fill: entry.color }, entry.category))
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(DonutCenter, { total: summary.totalSpentCents }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Tooltip,
                        {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 grid grid-cols-2 gap-x-4 gap-y-1.5", children: pieData.map((d2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-auto font-semibold tabular-nums text-foreground shrink-0", children: [
                            d2.percentage,
                            "%"
                          ] })
                        ]
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.div,
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 265, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    BarChart,
                    {
                      data: barData,
            ...
            motion.div,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "text-xs", children: "Last 6 months" })
                ] }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: trend.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-48 flex items-center justify-center text-muted-foreground text-sm", children: "Not enough data yet" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 220, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  BarChart,
                  {
                    data: trend,
                    margin: { top: 4, right: 4, left: -22, bottom: 0 },
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        YAxis,
                        {
                          ...
                          tickLine: false,
                          axisLine: false,
                          tickFormatter: (v2) => formatCompact(v2)
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Tooltip,
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Bar,
                        {
                          ...
                          opacity: 0.8,
                          children: trend.map((entry) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                            Cell,
                            {
                              fill: entry.isCurrent ? "oklch(0.52 0.16 195)" : "oklch(0.55 0.22 25)",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: tableData.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                ...
                ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: tableData.map((row, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    className: "flex items-center gap-3 group",
                    "data-ocid": `analytics.category_row.${i + 1}`,
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-base w-6 shrink-0 text-center", children: row.emoji }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm flex-none w-32 min-w-0 truncate font-medium", children: row.label }),
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm font-semibold tabular-nums w-20 text-right shrink-0", children: [
                        "$",
            ...
            motion.div,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Monthly limits" })
                ] }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: CATEGORIES.filter(
                  (cat) => cat !== "other" && cat !== "transfers"
                ).map((cat, i) => {
                  var _a2;
                  const budget = budgets.find((b2) => b2.category === cat);
                  const spent = ((_a2 = summary.categories.find((c2) => c2.category === cat)) == null ? void 0 : _a2.totalCents) ?? 0;
                  const limit = (budget == null ? void 0 : budget.limitCents) ?? 0;
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-2", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 min-w-0", children: [
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold capitalize truncate", children: cat })
                          ] }),
                          limit > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "span",
                            {
                              className: `text-xs px-2 py-0.5 rounded-full border font-semibold ${badgeClass}`,
                              children: over ? "Over!" : `${pct}%`
                            }
                          ) : /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "button",
                            {
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-2 bg-muted rounded-full overflow-hidden", children: limit > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "div",
                          {
                            className: "h-full rounded-full transition-smooth",
                            style: {
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-xs", children: [
                          ...
                          limit > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted-foreground font-mono", children: [
                            "of ",
                            formatCurrency(limit)
                          ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground/50 italic", children: "no limit set" })
                        ] })
                      ]
                    },
                    cat
          ...
          summary.topCounterparties.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              initial: { opacity: 0, y: 12 },
              animate: { opacity: 1, y: 0 },
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      summary.topCounterparties.slice(0, 5).map((cp, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "div",
                        {
                          ...
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground font-mono w-4 text-right shrink-0", children: i + 1 }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "div",
                              {
                                ...
                                children: getInitials(cp.name)
                              }
                            ),
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold truncate", children: cp.name }),
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right shrink-0", children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-bold tabular-nums text-foreground", children: formatCurrency(cp.totalCents) }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground", children: "total sent" })
                            ] }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-1.5 bg-muted rounded-full overflow-hidden hidden sm:block shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "div",
                              {
                      ...
                      summary.topCounterparties.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "p",
                        {
                          ...
                          children: "No outgoing transfers this month"
                        }
                      )
                    ]
                  }
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-4", children: [
                {
                  icon: Wallet,
                  color: "text-primary",
                  bg: "bg-primary/8",
                  label: "Savings Rate",
                  value: summary.totalReceivedCents > 0 ? `${Math.max(0, Math.round((summary.totalReceivedCents - summary.totalSpentCents) / summary.totalReceivedCents * 100))}%` : "—",
                  sub: "of income saved"
                },
                {
                  icon: Hash$2,
                  ...
                  value: String(
                    summary.categories.filter((c2) => c2.totalCents > 0).length
                  ),
                ...
                },
                {
                  ...
                  value: ((_a = tableData[0]) == null ? void 0 : _a.label) ?? "—",
                  sub: tableData[0] ? `${tableData[0].percentage}% of spend` : "no data"
                }
              ].map((ins, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  className: "flex items-center gap-3 bg-card border border-border rounded-xl px-4 py-3",
                  "data-ocid": `analytics.insight.${i + 1}`,
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `p-2 rounded-lg ${ins.bg} shrink-0`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ins.icon, { className: `h-4 w-4 ${ins.color}` }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: ins.label }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base font-bold font-display truncate", children: ins.value }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-muted-foreground", children: ins.sub })
                    ] })
                  ]
                },
                ins.label
